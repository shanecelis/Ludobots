...
public:
	...
	void	 AddColumn(double val);
	void	 AddRow(double val);
	...
	int      FirstRowWithSum(double val);
	...
	int	 NumOccurancesOf(double val);
	void     Permute(void);
	...
	int      ValFoundOffTheDiagonal(double val);
	void     ValFoundOffTheDiagonal(int *rowIndex, int *columnIndex, double val);
	int	 ValuesDifferentFrom(double val);
